...
export class ProductListComponent {
  ...
  products = [
    ...
    },
    {
      ...
      is_in_inventory: false,
      items_left: 7,
      imageURL: "https://th.bing.com/th?id=OIP.Jsk9byXeJmBL5PK_FBC7-gAAAA&w=250&h=250&c=8&rs=1&qlt=90&o=6&dpr=1.5&pid=3.1&rm=2",
      slug: "ss-ms-0075"
    },
    {
      id: 24,
    ...
    },
    {
      ...
      is_in_inventory: true,
      items_left: 3,
      imageURL: "https://res.cloudinary.com/dtydvdpcx/image/upload/v1715944775/cld-sample-5.jpg",
...
totalNumberOfInStock = this.products.filter(p=>p.is_in_inventory == true).length;
totalNumberOfOutStock = this.products.filter(p=>p.is_in_inventory == false).length
selectedFilterRedioButton: string ='all';

onFilterChanged(value: string){
  console.log(value)
  this.selectedFilterRedioButton = value;
}
}